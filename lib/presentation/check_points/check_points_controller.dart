...
class CheckPointsController extends LifecycleController {
  ...
  Future<void> openCheckPoint(CheckDayPointEntity checkPointDay) async {
    _checkPointsStore.checkPointDaySelected = checkPointDay;
    AppNavigator.toNamed(AppRouter.checkPoint);
  }
}

...
mixin ErrorCallbacksMixin {
  void onReceivedError(
    ...
    final List<String> networkConnectionErrors = [
    ...
    final bool isNetworkError =
        networkConnectionErrors.contains(error.description) ||
  ...
  void onReceivedHttpError(
    ...
    final List<int> skipErrors = [-999, 102];
    if (skipErrors.contains(errorResponse.statusCode)) return;

    final int statusCode = errorResponse.statusCode!;

    // final isClientError = [400, 401, 429].contains(statusCode);
    ...
    if (statusCode == 403) {
      return onError(
        ...
        error: 'onReceivedError Forbidden',
      );
    }
